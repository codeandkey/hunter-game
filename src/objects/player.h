...
#define HUNTER_PLAYER_MOVE_MAXSPEED 3 /* maximum movement xspeed */
#define HUNTER_PLAYER_MOVE_ACCEL 1 /* delta xspeed for acceleration */
#define HUNTER_PLAYER_MOVE_DECEL 1 /* asymptotic deceleration division constant "(new speed) = (old speed) / (decel cst)" */
#define HUNTER_PLAYER_GRAVITY -3 /* delta yspeed for gravity */
#define HUNTER_PLAYER_JUMP 6 /* immediate jump yspeed */
...
#define HUNTER_PLAYER_SLOPE_PADDING 0 /* lengthens AABB collision boxes for slopes on all sides */
#define HUNTER_PLAYER_SLOPE_CORRECT_OFFSET 0 /* (NO LONGER USED) offset the slope y correction */
#define HUNTER_PLAYER_EARLY_SLOPE_REJUMP 3 /* distance to enable jump at when moving down and hitting a slope */
#define HUNTER_PLAYER_LOOKUP_DELAY 500 /* delay in ms between key down and camera movement */
#define HUNTER_PLAYER_LADDER_SPEED 3 /* ladder movement yspeed */
